...
[HTML5](https://github.com/easy-saving), 
[Angular 2+](https://github.com/easy-saving), 
...
* [CoreUI Free Angular 2+ Admin Template](https://github.com/easy-saving)
...
``` bash
# clone the repo
$ git clone https://github.com/easy-saving.git my-project
...
Please read through our [contributing guidelines](https://github.com/easy-saving/blob/master/CONTRIBUTING.md). Included are directions for opening issues, coding standards, and notes on development.

Editor preferences are available in the [editor config](https://github.com/easy-saving/blob/master/.editorconfig) for easy use in common text editors. Read more and download plugins at <http://editorconfig.org>.

## Versioning

For transparency into our release cycle and in striving to maintain backward compatibility, CoreUI Free Admin Template is maintained under [the Semantic Versioning guidelines](http://semver.org/).

See [the Releases section of our project](https://github.com/easy-saving/releases) for changelogs for each release version.
...
copyright 2017-2021 creativeLabs Łukasz Holeczek. Code released under [the MIT license](https://github.com/easy-saving/blob/master/LICENSE).
